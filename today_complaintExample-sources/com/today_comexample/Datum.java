...
public class Datum {
    ...
    @Expose
    private List<AnaysisCompaint> anaysisCompaint;
    @SerializedName("__v")
    @Expose
    private Integer v;
    ...
    public List<AnaysisCompaint> getAnaysisCompaint() {
        return anaysisCompaint;
    }

    public void setAnaysisCompaint(List<AnaysisCompaint> anaysisCompaint) {
