...
import com.example.loginactivity.model.engineer_padding_compaint.Datum;
import com.example.loginactivity.pandding_complaint;

import java.util.List;

public class pandding_adapter  extends RecyclerView.Adapter<pandding_adapter.ViewHolder >{

        List<Datum> datumdata;

        Context context;

        public pandding_adapter(pandding_complaint finalPage, List<Datum> data) {
            this.datumdata = data;
